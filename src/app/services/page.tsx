            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                ...
                <p>
                  ...
                  We serve patients wherever they reside – whether it&apos;s a private home, 
              ...
              <div className="mt-12">
                <h3 className="text-2xl font-bold text-primary mb-6">Key Hospice Services</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Professional nursing care to ensure comfort</p>
                    </div>
                  </div>
              ...
              <div className="bg-neutral-bg rounded-lg p-6 sticky top-24">
                ...
                <ul className="space-y-3 text-sm text-gray-700">
                  <li className="flex items-center space-x-2">
                    ...
                    <span>No 6-month requirement</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
                    <span>Continue treatments if desired</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
                    <span>Keep your own doctor</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
      ...
      <section className="py-20 px-4 bg-neutral-bg">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
            ...
            <div className="bg-white border-l-4 border-secondary rounded-r-lg p-6 my-8">
